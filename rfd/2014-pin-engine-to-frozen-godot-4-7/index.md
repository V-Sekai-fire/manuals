---
title: "RFD 2014: Pin the engine to a frozen Godot 4.7 commit"
rfd: "2014"
state: published
...
- `rfd/2013-gitassembly-tag-release`: the tag fixes the assembly
  merged onto this pinned base.
- `rfd/2016-spatial-audio-patched-resonance-audio`: targets this fixed
  engine API.
