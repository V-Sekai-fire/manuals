---
title: "RFD 0089: Fly.io, not self-hosted podman quadlets, is the deployment target"
rfd: "0089"
state: published
...
`rfd/0061-quadlets-on-fedora-44-instead-of-harvester` chose self-hosted
...
- `rfd/0090-uro-burrito-release`: the real production release shape
