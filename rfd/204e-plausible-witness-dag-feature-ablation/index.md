---
title: "RFD 204e: plausible-witness-dag for zonefabric feature ablation"
rfd: "204e"
state: published
...
- `rfd/2051-three-layer-verification-strategy`: plausible-witness-dag's
  other role, as the runtime verification layer.
- `rfd/2050-slotmap-entity-storage`: the first feature this ablation
  verifies as foundational.
- `rfd/204c-macaroon-xdp-security`: security features ablated
