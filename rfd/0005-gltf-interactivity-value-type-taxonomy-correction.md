# RFD 0005: `gltf_interactivity`'s value types: primitive, `ref`, and `custom`

**State:** discussion

## Summary

`rfd/0001-zonefabric-roadmap-vs-mas-bandwidth-fps.md`, item 5, described
...
for CastSpell's own value-versus-handle split, per RFD 0001 item 5. A
...
reference to `rfd/0003-castspell-sandbox-package-and-manifest-encoding.md`)
...
1. Correct `rfd/0001-zonefabric-roadmap-vs-mas-bandwidth-fps.md`, item
