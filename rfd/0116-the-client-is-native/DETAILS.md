...
No XR. RFD 0085's setting is a ring station a player is inside. A browser field can show a
...
`webtransportd`, per RFD 0047 and the rule in `CLAUDE.md`. Entity state arrives as
...
The field regresses before it improves. RFD 0112's field works today. A `Control` that shows a
