---
title: "RFD 2069: Archive the self-host-era support repos and the empty stubs"
rfd: "2069"
state: published
...
- `rfd/203e-repository-and-capability-inventory`: the inventory this
  decision updates.

## Related

- `rfd/2059-flyio-over-podman-quadlets`: archives the quadlets that
  these repos support.
- `rfd/2041-fabric-platform-central-elixir-burrito-casync`: the
