---
title: "RFD 0126: Two see-through interactors, and the check that keeps the A/B one question"
rfd: "0126"
state: discussion
...
comparison into a comparison of two different jobs. RFD 0123 makes this argument for a second
...
`interactor-see-through-cpp` and `interactor-see-through-python`, for the reason RFD 0123 takes
...
- RFD 0123: the same argument for a second WebTransport implementation
