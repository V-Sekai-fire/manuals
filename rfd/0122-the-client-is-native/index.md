---
title: "RFD 0122: The client is native, from entities-godot's gyre branch"
rfd: "0122"
state: published
...
RFD 0112 put the Queen's client in a browser and chose Lexical for the slash command field, which was the hard half and was built. The field was the wrong thing to optimise for.
...
The slash command field becomes a `Control`, so RFD 0112's hard half stops being hard: a caret in a
...
- RFD 0112 chose the browser client and is abandoned; RFD 0085 holds the setting; RFD 0111 sets the words transport layer and service; RFD 0047 is why the Queen terminates QUIC herself
