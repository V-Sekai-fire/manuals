---
title: "RFD 204a: Binary value encoding for FDB values"
rfd: "204a"
state: published
...
- `rfd/2050-slotmap-entity-storage`: stores the same packed struct in
  memory, `memcpy` from FDB value to slotmap entry.
- `rfd/2054-zstd-compression-for-zone-state`: compresses the packed
