---
title: "RFD 206f: Convert the deployment words to the hexagon vocabulary"
rfd: "206f"
state: published
...
This stack names one component twice. RFD 201c names its structure; a second set names its
...
- RFD 201c, amended by this RFD; RFD 2079 amends this one against the tree. The term table, the collisions, and the rename list are in `DETAILS.md`
