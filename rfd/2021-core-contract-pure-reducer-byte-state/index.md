---
title: "RFD 2021: Cores as pure reducers over byte-serialized state"
rfd: "2021"
state: published
...
Every hexagonal core (`rfd/201c-hexagonal-core-ports-adapters`) needs
...
- `rfd/201c-hexagonal-core-ports-adapters`: the core/ports/adapters
  layout this contract fills in.
- `rfd/2022-deterministic-cores-integer-seeded-rng`: the determinism
  rule that makes replay byte-exact.
- `rfd/2020-core-codegen-lean-slang`: the compute kernels this
