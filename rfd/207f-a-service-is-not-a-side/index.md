---
title: "RFD 207f: A service is not a side, and sits past the ring at 7"
rfd: "207f"
state: discussion
...
RFD 206f gives this stack six words that name a position in the code, and the workspace is a
...
**`service/` unnumbered is still refused**, for the reason RFD 206f refused it. An unnumbered
...
`7-service/`. Both READMEs still say "edge plane", a compound RFD 206f retired, so adding them
turns `mix check words` red until they are rewritten. That is a small change and a separate one.

## References

- RFD 206f: the six words, and the eight directories it removed
- RFD 2079: the earlier amendment of RFD 206f against the tree
