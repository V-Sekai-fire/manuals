---
title: "RFD 2079: Amend RFD 206f against the tree"
rfd: "2079"
state: discussion
...
RFD 206f is executed: the thirty renames landed, and GitHub redirects each old
...
Amend RFD 206f in four places. `DETAILS.md` holds the evidence for each, with the
...
| `ports/` becomes `repositories/`         | `repository` is the one collision RFD 206f creates                          | rename to `repository/`, singular              |
...
`progression` do hold the RFD 201c triad, so that statement stands.
...
- RFD 206f, amended by this RFD. RFD 201c, for the triad this RFD keeps naming
