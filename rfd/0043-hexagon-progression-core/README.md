...
through the mTLS store (`rfd/0006-cockroachdb-with-mtls-role-separation`).
...
- `rfd/0006-cockroachdb-with-mtls-role-separation`: the mTLS store the
  `cockroach` adapter commits through.
- `rfd/0041-hexagon-loot-core`: the loot core whose drops this
