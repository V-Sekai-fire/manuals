...
The [loot-action core-loop slice](../202d-loot-action-core-loop-mvp-vertical-slice/README.md)
...
- [`lean-connection-fsm`](https://github.com/v-sekai-multiplayer-fabric/lean-connection-fsm):
  ...
  inside the
  [five-second transaction limit](../2032-five-second-transaction-limit/README.md).
