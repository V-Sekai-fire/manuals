...
The renames of RFD 0111 have landed. GitHub answers the old names with the new
ones:
...
`^fabric` and is the name RFD 0111 frees, so it is excluded here.
...
Five archived and four forks leave six live and owned. RFD 0111 names
...
RFD 0111 defends this name in one paragraph, and the paragraph argues a different
...
The test RFD 0111 applies elsewhere is whether a name asserts something false.
...
RFD 0111 renames the RFD 0028 triad in three git repositories. Those three exist
...
RFD 0111 states the resolution for the word it takes from Netflix: write "git
...
The `domain` field on the wire in RFD 0091 is still unrenamed, and still needs
its own RFD, as RFD 0111 says.
