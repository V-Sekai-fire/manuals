...
- The measurements, the back-pressure rule, and the sandbox trade:
  `DETAILS.md`
- `rfd/0097-pubsub-belongs-in-userspace`, `fdbpub.c`

## Related

- `rfd/0107-janet-scripting-over-a-c-taskweft-core`: the tier this
  fills in.
- `rfd/0049-fabric-channels-as-reliability-classes`: the vocabulary the
  back-pressure rule uses.
- `rfd/0094-minimum-ugc-game-loop-guest-composition`: the UGC loop this
