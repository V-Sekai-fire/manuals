---
title: "RFD 206b: Janet scripting over a C taskweft core, behind h2o"
rfd: "206b"
state: abandoned
...
- `rfd/2053-zone-server-h2o-replaces-godot-fabriczone`: the host this
  amends rather than replaces.
- `rfd/204b-fdb-over-cockroachdb-for-zone-state`: the database choice
  this keeps.
- `rfd/205d-compile-taskweft-to-linear-automata`: the taskweft
