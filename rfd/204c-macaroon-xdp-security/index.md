---
title: "RFD 204c: Macaroon + eBPF/XDP security fabric"
rfd: "204c"
state: published
...
- Source: `weftspun/h2o-bench-tpcc`, `rfd/2012-macaroon-xdp-security.md`
...
- `rfd/2050-slotmap-entity-storage`: the `entity_id` caveat maps to a
  slotmap handle.
- `rfd/2048-actor-lite-worker-pool`: the orchestrator that validates
