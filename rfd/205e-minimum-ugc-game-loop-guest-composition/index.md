---
title: "RFD 205e: zone-server-h2o hosts the minimum UGC game loop"
rfd: "205e"
state: discussion
...
- `rfd/205c-rebac-gates-libriscv-guest-access`: the gating model
  this RFD binds to a host repo and a loop definition.
- `rfd/204f-sandboxed-godot-in-zone-server-h2o-via-raw-libriscv`:
  the sandboxing decision behind `zone-guest-godot`.
- `rfd/2053-zone-server-h2o-replaces-godot-fabriczone`: the rule
