---
title: "RFD 2071: FoundationDB on Windows, built from source"
rfd: "2071"
state: discussion
...
- `rfd/206d-two-tiers-with-foundationdb-as-the-store`: why the store is FoundationDB.

## Related

- `rfd/2072-prove-the-store-by-breaking-it`: how a built store is verified.
