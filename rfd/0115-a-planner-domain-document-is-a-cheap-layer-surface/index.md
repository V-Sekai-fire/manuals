---
title: "RFD 0115: A planner domain document is a cheap-layer surface"
rfd: "0115"
state: discussion
...
RFD 0003 settled the cheap layer: CBOR-LD, `QCBOR` over `zcbor`, RFC 8949
...
**A planner domain document is a cheap-layer surface.** RFD 0003's
...
**Determinism holds for a local reason.** RFD 0003 wanted it for `casync`
...
- `rfd/0003-castspell-sandbox-package-and-manifest-encoding`: every term
  this RFD reuses, and the reasoning behind each.

## Related

- `rfd/0093-compile-taskweft-to-linear-automata`: the planner this feeds.
- `rfd/0107-janet-scripting-over-a-c-taskweft-core`: the other consumer of
