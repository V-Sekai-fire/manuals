---
title: "RFD 206e: One pinned Godot build, hosted as a Rivet actor"
rfd: "206e"
state: discussion
...
- `rfd/2053-zone-server-h2o-replaces-godot-fabriczone`: the decision
  this reverses, because the zone returns to Godot.
- `rfd/2025-generated-behavior-sandboxed-riscv`: the libriscv path
  inside the engine.
- `rfd/2014-pin-engine-to-frozen-godot-4-7`: the pinning practice this
  applies to one named tag.
- `rfd/206d-two-tiers-with-foundationdb-as-the-store`: the store and the
  relay this replaces.
