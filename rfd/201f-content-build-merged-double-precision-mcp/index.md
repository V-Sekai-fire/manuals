---
title: "RFD 201f: Content creation in a single merged double-precision build via the editor MCP"
rfd: "201f"
state: published
...
- `rfd/201d-cassie-desktop-curvenet-authoring`: the same no-Blender
  authoring path.
