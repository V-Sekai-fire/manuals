---
title: "RFD 2038: Verification smokes as a systemd podman quadlet queue"
rfd: "2038"
state: published
...
- `rfd/2033-headless-openxr-testing-with-monado`: one of the four
  smokes this queue runs.
- `rfd/201e-cicd-runners-as-queueing-system`: the runner model this
