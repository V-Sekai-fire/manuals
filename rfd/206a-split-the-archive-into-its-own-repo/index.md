---
title: "RFD 206a: Split the archive into its own repository"
rfd: "206a"
state: published
...
- `rfd/2047-yagni-times-structure-to-need`: the rule that sends a
  superseded record to the archive.
- `rfd/203e-repository-and-capability-inventory`: lists the new
  repository.
