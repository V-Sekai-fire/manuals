...
| `rfd/2047-yagni-times-structure-to-need/index.md`                       | Two pointers to `_archive` now name the archive repository.                         |
| `rfd/2059-flyio-over-podman-quadlets/index.md`                          | The `rfd/0061` reference now links to the archive.                                  |
| `rfd/203c-org-scoped-github-app-token-for-gh-access/index.md`           | The `rfd/0061` reference now links to the archive.                                  |
| `rfd/2046-loop-slice-telemetry-to-the-observability-collector/index.md` | The `rfd/0011` reference now links to the archive.                                  |
| `rfd/203e-repository-and-capability-inventory/DETAILS.md`               | The two-org split decision path now links to the archive.                           |
