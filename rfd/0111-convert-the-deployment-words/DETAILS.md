...
`fabric-flow-adapters` and its `-project` companion carry RFD 0028's
...
it comes from upstream, and it is not the "core" of RFD 0028. Renaming it
...
"Interactor" was challenged on the ground that RFD 0000 applies ASD-STE100,
