---
title: "RFD 2049: Async FDB callback chain on the libh2o event loop"
rfd: "2049"
state: published
...
- Source: `weftspun/h2o-bench-tpcc`, `rfd/200b-async-fdb-callback-chain.md`
- Consolidation target: `v-sekai-multiplayer-fabric/zone-server-h2o`

## Related

`rfd/2048-actor-lite-worker-pool`: the worker thread this callback
chain runs inside.
