---
title: "RFD 0127: A service is not a side, and sits past the ring at 7"
rfd: "0127"
state: discussion
...
RFD 0111 gives this stack six words that name a position in the code, and the workspace is a
...
**`service/` unnumbered is still refused**, for the reason RFD 0111 refused it. An unnumbered
...
`7-service/`. Both READMEs still say "edge plane", a compound RFD 0111 retired, so adding them
turns `mix check words` red until they are rewritten. That is a small change and a separate one.

## References

- RFD 0111: the six words, and the eight directories it removed
- RFD 0121: the earlier amendment of RFD 0111 against the tree
