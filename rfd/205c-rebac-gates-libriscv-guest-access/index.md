---
title: "RFD 205c: ReBAC gates libriscv guest access, not five callbacks"
rfd: "205c"
state: discussion
...
- `rfd/204f-sandboxed-godot-in-zone-server-h2o-via-raw-libriscv`: the
  sandboxing decision this gates.
- `rfd/2056-defer-nogod-gossip-zone-authority`: the other place
  `lean-rebac-core` is already in scope.
- `rfd/205d-compile-taskweft-to-linear-automata`: closes questions 4
  and 7.
