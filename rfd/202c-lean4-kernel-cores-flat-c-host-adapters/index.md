---
title: "RFD 202c: Lean 4 build-time kernel cores with flat-C host adapters"
rfd: "202c"
state: published
...
The hexagonal cores (`rfd/201c-hexagonal-core-ports-adapters`) hold
...
(`rfd/2021-core-contract-pure-reducer-byte-state`). Its compute
kernels lower through `lean-slang` to SPIR-V
(`rfd/2020-core-codegen-lean-slang`), and the spec suite drives the C
...
- `rfd/2020-core-codegen-lean-slang`: the Lean-to-SPIR-V compute
  kernel codegen these cores dispatch.
- `rfd/2021-core-contract-pure-reducer-byte-state`: the pure-reducer
