---
title: "RFD 2048: Actor-lite worker pool architecture for zone-server-h2o"
rfd: "2048"
state: published
...
- `rfd/2049-async-fdb-callback-chain`: how each worker drives FDB
  without blocking its ring.
- `rfd/204d-pert-critical-path-zonefabric`: task C in the build order.
