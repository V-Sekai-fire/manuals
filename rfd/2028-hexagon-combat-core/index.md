---
title: "RFD 2028: Combat hexagon — core, ports, and adapters"
rfd: "2028"
state: published
...
combat as a hexagon (`rfd/201c-hexagonal-core-ports-adapters`). The
...
(`rfd/2021-core-contract-pure-reducer-byte-state`) over deterministic
state (`rfd/2022-deterministic-cores-integer-seeded-rng`). Driving
...
authority. Sandboxed behavior (`rfd/2025-generated-behavior-sandboxed-riscv`)
...
- `rfd/2025-generated-behavior-sandboxed-riscv`: the `behavior_source`
