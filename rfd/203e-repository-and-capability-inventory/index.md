---
title: "RFD 203e: Repository and capability inventory for the multiplayer fabric"
rfd: "203e"
state: published
...
- `rfd/2039-vertical-slice-repository-map`: the narrower map of just
  the loot-action vertical slice.
- `rfd/2012-feature-classification-poc-baseline-stretch`: the tier
