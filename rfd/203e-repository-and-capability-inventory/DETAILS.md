...
(`rfd/2039-vertical-slice-repository-map`) indexes only the
...
(`rfd/2012-feature-classification-poc-baseline-stretch`).

Names here are the current names, per `rfd/2040-kebab-case-repos-snake-case-local-checkouts`.
...
| Spatial audio (HRTF + audio probes, `rfd/2016-spatial-audio-patched-resonance-audio`) | Baseline         | `feat/spatial-audio-server`, `feat/module-resonance-audio` (patched Resonance Audio) | [sponza-godot-audio](https://github.com/v-sekai-multiplayer-fabric/sponza-godot-audio)                                                                                             | Working; demo and benchmark scene.                                                    |
