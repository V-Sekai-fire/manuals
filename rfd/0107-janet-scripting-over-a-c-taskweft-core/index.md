---
title: "RFD 0107: Janet scripting over a C taskweft core, behind h2o"
rfd: "0107"
state: abandoned
...
- `rfd/0083-zone-server-h2o-replaces-godot-fabriczone`: the host this
  amends rather than replaces.
- `rfd/0075-fdb-over-cockroachdb-for-zone-state`: the database choice
  this keeps.
- `rfd/0093-compile-taskweft-to-linear-automata`: the taskweft
