...
combat as a hexagon (`rfd/0028-hexagonal-core-ports-adapters`). The
...
(`rfd/0033-core-contract-pure-reducer-byte-state`) over deterministic
state (`rfd/0034-deterministic-cores-integer-seeded-rng`). Driving
