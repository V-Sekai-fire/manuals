...
`rfd/0028-hexagonal-core-ports-adapters` it becomes a core behind
narrow ports.
...
as a pure reducer (`rfd/0033-core-contract-pure-reducer-byte-state`)
over deterministic state
(`rfd/0034-deterministic-cores-integer-seeded-rng`).
