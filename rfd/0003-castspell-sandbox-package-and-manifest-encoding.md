# RFD 0003: CastSpell sandbox package format and manifest encoding

**State:** discussion

## Summary

`rfd/0001-zonefabric-roadmap-vs-mas-bandwidth-fps.md`, item 4, commits
...
`rfd/0001-zonefabric-roadmap-vs-mas-bandwidth-fps.md`). It also reads
