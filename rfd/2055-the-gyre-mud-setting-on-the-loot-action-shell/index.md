---
title: "RFD 2055: The Gyre — a MUD setting on the loot-action core-loop shell"
rfd: "2055"
state: discussion
...
- `rfd/202d-loot-action-core-loop-mvp-vertical-slice`: defines the
  Hub/Field loop and the five core systems that The Gyre reuses.
- `rfd/201c-hexagonal-core-ports-adapters`,
  `rfd/202b-hexagon-progression-core`: describe the shape a future
