---
title: "RFD 2054: zstd compression for batched zone-state FDB values"
rfd: "2054"
state: published
...
- `rfd/204a-binary-value-encoding-for-fdb`: the packed struct format
  zstd compresses.
- `rfd/2052-zonefabric-scaling`: the batched `zf/zone_state/` blob
