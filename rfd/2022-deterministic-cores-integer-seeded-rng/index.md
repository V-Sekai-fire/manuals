---
title: "RFD 2022: Deterministic cores via r128 fixed-point and seeded RNG"
rfd: "2022"
state: published
...
- `rfd/2021-core-contract-pure-reducer-byte-state`: the byte-state
  contract this determinism rule makes replayable.
- `rfd/2029-hexagon-loot-core`: the seeded roll this rule backs.
