---
title: "RFD 0110: One pinned Godot build, hosted as a Rivet actor"
rfd: "0110"
state: discussion
...
- `rfd/0083-zone-server-h2o-replaces-godot-fabriczone`: the decision
  this reverses, because the zone returns to Godot.
- `rfd/0037-generated-behavior-sandboxed-riscv`: the libriscv path
  inside the engine.
