---
title: "RFD 2058: zone-server-h2o's transport is picoquic + picotls, not h2o's own QUIC"
rfd: "2058"
state: published
...
- `rfd/2017-webtransport-http3-transport`: the client-side
  `modules/http3` decision this shares a QUIC stack with.
- `rfd/2053-zone-server-h2o-replaces-godot-fabriczone`
